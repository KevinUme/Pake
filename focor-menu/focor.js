...
(function () {
  ...
  function model(sel) {
    ...
    return [
      ...
      { type: "label", label: "Focor" },
      {
        type: "item",
        id: "loop",
        label: "Track as open loop",
        icon: I.loop,
        badge: "Preview",
        info: {
          title: "Track as open loop",
          desc: "Turn the selected commitment into a tracked open loop — monitored both ways (you-owe / they-owe), with a due date and its Genesis source.",
          ...eg("Adds to your Open Loops"),
        },
      },
      {
        type: "item",
        ...
        badge: "Preview",
        info: {
          title: "Add to Objectives",
          desc: "Promote this into a tracked objective with a time horizon, so it shapes what Focor surfaces as important to you.",
          ...eg("Creates a tracked Objective"),
        },
      },
      {
        type: "item",
        ...
        info: {
          title: "Trace Genesis",
          desc: "Trace this back to the exact email, meeting, or message that produced it. Every decision has a source — no black boxes.",
      ...
      },
      {
        ...
        info: {
          title: "Find related",
          desc: "Surface the people, decisions, and threads connected to this. Context, not keyword search.",
          ...eg("Shows connected people & decisions"),
        },
      },
    ];
  }
  ...
  function act(id) {
    if (id === "copy") {
      ...
      const names = {
        loop: "Track as open loop",
        objective: "Add to Objectives",
